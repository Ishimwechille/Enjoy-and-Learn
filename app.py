...
app.config['MAIL_USERNAME'] = 'niyokwizerajd123@gmail.com'  # Replace with your email
app.config['MAIL_PASSWORD'] = 'nxpr gtiz afdf wmvv'  # Replace with your email password
app.config['MAIL_DEFAULT_SENDER'] = 'niyokwizerajd123@gmail.com'  # Replace with your email
